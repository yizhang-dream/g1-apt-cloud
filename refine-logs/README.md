...
│   │   ……………………………………………………………杀封存记录在内）。活跃
│   ├── DS_GAIT_MANIFOLD_PLAN.md…………… 执行计划：DS 步态流形（Phase 0–5：
│   │   ……………………………………………………………官方回路采集 4 族 {SLOW,
│   │   ……………………………………………………………HAPPY,RUN,JUMP}+过渡段 → VAE
│   │   ……………………………………………………………（vb 连续速度+regime 轴）→ RL
│   │   ……………………………………………………………底板 → TO42 配方 4 族
│   │   ……………………………………………………………切换；Phase 0 = Isaac
│   │   ……………………………………………………………执行校准前置门；
...
- **专题日志域**：顶层 28 篇专题——16 篇历史冻结/归档存档（运行日志 / 机制与
  数据专题 / 收束报告 / 调研 / 计划）+ TO_TORQUE_MAINLINE 与 TO38–TO42 力矩主线
  近期文档（TO41 系列七篇收束、TO42 活跃）。
