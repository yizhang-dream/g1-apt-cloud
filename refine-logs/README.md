...
- **专题日志域**：顶层 36 篇专题——16 篇历史冻结/归档存档（运行日志 / 机制与
  数据专题 / 收束报告 / 调研 / 计划）+ TO_TORQUE_MAINLINE 与 TO38–TO42 力矩主线
  近期文档（TO41 系列七篇收束、TO42 活跃）+ **DS 线六篇（纲领
  DS_TERRAIN_ADAPTER_CHARTER = 主线活跃** + 官方数据独走执行计划 + 重采
  （09-05b 退役冻结）/流形/官方数据规范/S2R 证据）+ TRAIN_SPEEDUP_LOG。
