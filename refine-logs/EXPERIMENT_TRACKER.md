...
| D | [tracker/D.md](../refine-logs/tracker/D.md) | 蒸馏 Distillation 线（Distillation Experiment/Phase2/Phase3 + Stress Test）+ Recollect 重采线（09-04 起主攻线，DS_RECOLLECT_PLAN.md）+ 训练栈提速（D039，TRAIN_SPEEDUP_LOG.md） | 38（另有 D021–D028 共 4 行混排在 E.md『地形/数据泛化/感知』节，该节以 E 线为主未拆；D036–D038 落账时索引漏更，本次补正 34→38） |
