...
| D | [tracker/D.md](../refine-logs/tracker/D.md) | 蒸馏 Distillation 线（Distillation Experiment/Phase2/Phase3 + Stress Test）+ Recollect 重采线（09-04 起主攻线，DS_RECOLLECT_PLAN.md）+ 官方数据独走（09-05b 起，DS_OFFICIAL_DATA_PLAN.md）+ 训练栈提速（D039，TRAIN_SPEEDUP_LOG.md） | 39（另有 D021–D028 共 4 行混排在 E.md『地形/数据泛化/感知』节，该节以 E 线为主未拆；D036–D038 落账时索引漏更，前次补正 34→38，本次 D040 +1） |
...
表行合计 239（其中 R/D/E/MQ/TO 主线编号行 173，其余为蒸馏 gait 行、FB/I/T/P/G
