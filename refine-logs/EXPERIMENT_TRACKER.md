...
| E | [tracker/E.md](../refine-logs/tracker/E.md) | Isaac APT 主线 E01–E49（含 FB/I21/T1-T2 等辅助行与上述混合节） | 96（09-05d E49 三行 + 09-05 晚修正轮四行：init-ctrl 未训练对照 14.4m 零摔 / fix-s0 修正基线无单调崩但判据 FAIL（真 akl 10–500、clip 0.83）/ lr1e4 降温臂 RUNNING；kl≤150 判据已撤回，详见 E49_STATUS §3b） |
