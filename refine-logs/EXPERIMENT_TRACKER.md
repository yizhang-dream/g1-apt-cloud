...
| E | [tracker/E.md](../refine-logs/tracker/E.md) | Isaac APT 主线 E01–E49（含 FB/I21/T1-T2 等辅助行与上述混合节） | 99（09-05 深夜诊断轮三行：**rew-floor 奖励地板 1.641 与 lr1e4 实测 1.644 精确吻合** / diag-sample it_50 采样鲁棒 / trainer-fix2 timeout 终末自举+整轮 KL 10/10 PASS；lr1e4 行 DONE 负结果=双评全站立、clip 恒 0.42–0.55 非 lr 单因子；owner 决策转"训练—评测一致性诊断"四步、暂缓奖励调参与 E49-B，详见 E49_STATUS §3c） |
