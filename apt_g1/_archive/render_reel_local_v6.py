"""Local v6 (distill_final) highlight reel for comparison."""
import json
import os
import sys
...
odir = os.path.join(LOCAL, "outputs", "distill_final")
...
labels = {
    "idle": "v6 IDLE",
    "walk_fwd": "v6 WALK FWD",
    "walk_back": "v6 WALK BACK",
    "walk_bin5": "v6 WALK +45 (fallback fwd)",
    "walk_bin3": "v6 WALK -45 (fallback fwd)",
    "walk_bin7": "v6 WALK +135 (fallback)",
    "jump": "v6 FORWARD JUMP",
    "slow_fwd": "v6 SLOW WALK",
}

out = os.path.join(odir, "v6_reel_local.mp4")
