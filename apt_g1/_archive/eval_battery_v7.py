...
odir = '/home/cvgluser/ros2_data/apt_g1/outputs/distill_v7'
...
json.dump(out, open(f'{odir}/eval_battery_v7.json', 'w'), indent=1)
...
json.dump({'switch': sw, 'schedule': sched}, open(f'{odir}/eval_switch_v7.json', 'w'), indent=1)
print('done')