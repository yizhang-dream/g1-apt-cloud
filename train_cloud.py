...
import sys as _sys
# ROOT CAUSE (2026-08-31, dev-instance bisect pp1-pp8): Path(...).parent returns a
# PosixPath OBJECT; inserting it into sys.path makes kit's startup cast the
# sys.path list to C++ vector<string> -> "Unable to cast <class 'list'>" at
# app.startup. Must wrap with str(). (This line came from the 08-30 header.)
_sys.path.insert(0, str(__import__('pathlib').Path(__file__).resolve().parent))
import os as _os
_os.chdir(str(__import__('pathlib').Path(__file__).resolve().parent))
